...
interface WebDataPaginationProps {
  pagination: {
    total: number;
    page: number;
    page_size: number;
...
export function WebDataPagination({
  pagination,
  currentPage = 1,
  currentPageSize = 10,
  selectedCount = 0,
    ...
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <p className={paginationSummaryClass}>
        {selectedCount > 0 ? (
          ...
          <>
            <Globe className="size-4 text-primary/60 dark:text-primary/70" />
            <span>
              Hiện có{" "}
      ...
      <div className="flex flex-wrap items-center gap-2">
        <div className="hidden items-center gap-2 lg:flex">
          <Label
            htmlFor="web-data-rows-per-page"
